...
- (void)awakeFromNib {
    ...
    //  viewParent.frame = CGRectMake(0, 0, SCREEN_WIDTH-2*padding, 75.0);
...
//    }];
    //[self addDotLineToLabel: lbSepa startPoint:CGPointMake(0, 5) endPoint:CGPointMake(0, 90-15.0)];
...
- (void)addDotLineToLabel: (UILabel *)label startPoint: (CGPoint)start endPoint:(CGPoint)end
{
    ...
    line.fillColor = nil;
    line.opacity = 1.0;
    line.strokeColor = GRAY_150.CGColor;
