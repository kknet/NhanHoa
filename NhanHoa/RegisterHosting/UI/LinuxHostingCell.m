...
@synthesize viewHeader, imgType, lbName, lbPrice, lbMemory, lbMemoryValue, lbSepa1, lbBandwidth, lbBandwidthValue, lbSepa2, lbFTP, lbFTPValue, lbSepa3, lbMySQL, lbMySQLValue, lbSepa4, lbDomain, lbDomainValue, lbSepa5, lbSubdomain, lbSubdomainValue, lbSepa6, lbAliasOrParkDomain, lbAliasOrParkDomainValue, lbSepa7, lbEmail, lbEmailValue, lbSepa8, lbAmount, tfAmount, imgArrAmount, btnAmount, lbSepa9, btnAddCart;
