...
@protocol ChooseEmailPackageViewDelegate <NSObject>
@optional
- (void)closeChooseEmailPackageView;
- (void)confirmAfterChooseEmailPackageView;
@end

@interface ChooseEmailPackageView : UIView<UITableViewDelegate, UITableViewDataSource>

@property (nonatomic, strong) id<ChooseEmailPackageViewDelegate, NSObject> delegate;
