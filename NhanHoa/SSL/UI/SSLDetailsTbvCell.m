...
@implementation SSLDetailsTbvCell
@synthesize imgDot, lbTitle, lbValue;
...
- (void)awakeFromNib {
    ...
    [imgDot mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [lbTitle mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.equalTo(imgDot.mas_right).offset(10.0);
        make.top.bottom.equalTo(self);
